...
export function loadConfig() {
    ...
    if (window.electronAPI && typeof window.electronAPI.getConfig === 'function') {
        ...
        _config = {
            ...
            branding: { productName: 'SolveIT Support Tool', tagline: '', supportEmail: '', logoPath: '../../assets/icons/Logo.png' },
            attachments: { maxCount: 5, maxSizeMb: 20, blockedExtensions: [] },
            toast: { durationMs: 4000 },
            demo: {
                firstName: 'Demo', lastName: 'User', email: '',
                phone: '', extension: '', department: 'General', jobTitle: 'Employee'
            }
        };
    }
